    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
      <div className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-xl w-full max-w-md shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar transition-colors duration-200">
        ...
        <div className="p-6 space-y-8">
             ...
             <div className="bg-gray-50 dark:bg-neutral-850 p-4 rounded-lg border border-gray-200 dark:border-neutral-800 space-y-3">
                <div>
                  ...
                  <div className="relative">
                    <input 
                        ...
                        onChange={(e) => onSave({ ...settings, openaiConfig: { ...OPENAI_DEFAULT_CONFIG, ...settings.openaiConfig, apiKey: e.target.value } })}
                        placeholder="sk-..."
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onSave({ ...settings, openaiConfig: { ...OPENAI_DEFAULT_CONFIG, ...settings.openaiConfig, baseUrl: e.target.value } })}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onSave({ ...settings, openaiConfig: { ...OPENAI_DEFAULT_CONFIG, ...settings.openaiConfig, model: e.target.value } })}
                    placeholder="gpt-4o"
            ...
            <div className="bg-gray-50 dark:bg-neutral-850 border border-gray-200 dark:border-neutral-800 rounded-xl p-4 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onSave({ ...settings, openaiGeminiTTSConfig: { ...OPENAI_GEMINI_TTS_DEFAULT_CONFIG, ...settings.openaiGeminiTTSConfig, apiKey: e.target.value } })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onSave({ ...settings, openaiGeminiTTSConfig: { ...OPENAI_GEMINI_TTS_DEFAULT_CONFIG, ...settings.openaiGeminiTTSConfig, baseUrl: e.target.value } })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onSave({ ...settings, openaiGeminiTTSConfig: { ...OPENAI_GEMINI_TTS_DEFAULT_CONFIG, ...settings.openaiGeminiTTSConfig, model: e.target.value } })}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => onSave({ ...settings, openaiGeminiTTSConfig: { ...OPENAI_GEMINI_TTS_DEFAULT_CONFIG, ...settings.openaiGeminiTTSConfig, voiceName: e.target.value } })}
                  className="w-full bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-neutral-700 rounded-lg p-2.5 focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none text-sm"
                >
          ...
          <div>
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 flex items-center gap-2">
              <ImageIcon size={14} className="text-green-500" /> Image Generation (OpenAI Format)
            </h3>
            <div className="bg-gray-50 dark:bg-neutral-850 border border-gray-200 dark:border-neutral-800 rounded-xl p-4 space-y-3">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                Configure image generation via OpenAI-compatible API endpoint.
              </p>
              <div>
                <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">API Key</label>
                <input
                  type="text"
                  value={settings.openaiImageConfig?.apiKey || ''}
                  onChange={(e) => onSave({ ...settings, openaiImageConfig: { ...OPENAI_IMAGE_DEFAULT_CONFIG, ...settings.openaiImageConfig, apiKey: e.target.value } })}
                  placeholder="Enter API key for image generation"
                  className="w-full bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-neutral-700 rounded-lg p-2.5 focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none text-sm"
                />
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Base URL</label>
                <input
                  type="text"
                  value={settings.openaiImageConfig?.baseUrl || ''}
                  onChange={(e) => onSave({ ...settings, openaiImageConfig: { ...OPENAI_IMAGE_DEFAULT_CONFIG, ...settings.openaiImageConfig, baseUrl: e.target.value } })}
                  placeholder="https://api.openai.com/v1"
                  className="w-full bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-neutral-700 rounded-lg p-2.5 focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none text-sm"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  value={settings.openaiImageConfig?.model || OPENAI_IMAGE_DEFAULT_CONFIG.model}
                  onChange={(e) => onSave({ ...settings, openaiImageConfig: { ...OPENAI_IMAGE_DEFAULT_CONFIG, ...settings.openaiImageConfig, model: e.target.value } })}
                  placeholder="dall-e-3"
                  className="w-full bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-neutral-700 rounded-lg p-2.5 focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none text-sm font-mono"
                />
              </div>
              {settings.openaiImageConfig?.apiKey && settings.openaiImageConfig?.baseUrl && (
